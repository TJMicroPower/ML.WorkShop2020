...
new Vue({
    ...
    data() {
        ...
        return {
            ...
            dialog:
            {
                ...
                data:
                {
                    id:'',nickName: '', account: '', password: '', name: '', gender: '', balance: '', openId: ''
                },
                rules:
                {
                    name:
    ...
    methods:
    {
        ...
        handleEdit(index, row, flag)
        {
            ...
            // 编辑
            let { id,nickName, account, password, name, gender, balance, openId } = row;
            that.dialog.data = {
                id,nickName, account, password, name, gender, balance, openId
            };
        ...
        updateData()
        {
            ...
            that.$refs['dataForm'].validate(valid => {
                ...
                if (valid)
                {
                    that.dialog.updateLoading = true;
                    let data = {
                        Id: that.dialog.data.id,                        NickName: that.dialog.data.nickName,
                        ...
                        OpenId: that.dialog.data.openId
                    };
