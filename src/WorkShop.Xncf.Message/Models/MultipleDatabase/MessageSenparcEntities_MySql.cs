...
namespace WorkShop.Xncf.Message.Models.DatabaseModel
{
    ...
    public class MessageSenparcEntities_MySql : MessageSenparcEntities
    {
        public MessageSenparcEntities_MySql(DbContextOptions<MessageSenparcEntities_MySql> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2、运行：PM> add-migration [更新名称] -c MessageSenparcEntities_MySql -o Migrations/Migrations.MySql </para>
    /// </summary>
    public class SenparcDbContextFactory_MySql : SenparcDesignTimeDbContextFactoryBase<MessageSenparcEntities_MySql, Register>
    {
